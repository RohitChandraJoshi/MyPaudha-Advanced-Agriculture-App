...
import com.example.plant_disease_detection.ml.MedicinalPlants;
...
public class MedicinalPlants_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicinalplants);
    ...
    private void classifyImage(Bitmap image) {
        try {
            MedicinalPlants model = MedicinalPlants.newInstance(getApplicationContext());
            ...
            MedicinalPlants.Outputs outputs = model.process(inputFeatureO);
            ...
            String[] classes = {
                    ...
                    "Bamboo", "Beans", "Betel", "Bhrami", "Bringaraja", "camphor", "Caricature", "Castor", "Catharanthus",
                    "Chakte", "Chilly", "Citron lime (herelikai)", "Coffee", "Common rue(naagdalli)", "Coriander", "Curry",
                    "Doddpathre", "Drumstick", "Ekka", "Eucalyptus", "Ganigale", "Ganike", "Gasagase", "Ginger", "Globe Amarnath",
                    "Guava", "Henna", "Hibiscus", "Honge", "Insulin", "Jackfruit", "Jasmine", "kamakasturi", "Kambajala",
                    "Kasambruga", "kepala", "Kohlrabi", "Lantana", "Lemon", "Lemongrass", "Malabar_Nut", "Malabar_Spinach",
                    "Mango", "Marigold", "Mint", "Neem", "Nelavembu", "Nerale", "Nooni", "Onion", "Padri", "Palak(Spinach)",
                    "Papaya", "Parijatha", "Pea", "Pepper", "Pomegranate", "Pumpkin", "Radish", "Rose", "Sampige", "Sapota",
                    "Seethaashoka", "Seethapala", "Spinach1", "Tamarind", "Taro", "Tecoma", "Thumbe", "Tomato", "Tulsi",
                    "Turmeric", "ashoka", "kamakasturi", "kepala", "Common rue(naagdalli)", "Ginger", "Honge", "Insulin",
                    "Jackfruit", "Pomegranate", "Raddish", "Sampige", "Spinach1", "Tecoma", "Thumbe", "Tomato", "Tulsi", "Turmeric"
            };


            if (maxConfidence < 0.98) {
                result2.setText("Detected image is not a plant. Please try again.");
                ...
                result2.setText("Benefits of : " + classes[maxPos]);
