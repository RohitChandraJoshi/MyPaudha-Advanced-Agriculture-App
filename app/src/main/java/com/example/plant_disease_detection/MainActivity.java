...
import com.example.plant_disease_detection.ml.NewPlantDiseaseDetection88;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void classifyImage(Bitmap image) {
        try {
            NewPlantDiseaseDetection88 model = NewPlantDiseaseDetection88.newInstance(getApplicationContext());
            ...
            NewPlantDiseaseDetection88.Outputs outputs = model.process(inputFeatureO);
            ...
            String[] classes = {
                    ...
                    "Sugarcane__bacterial_blight", "Sugarcane__healthy", "Sugarcane__red_rot", "Sugarcane__red_stripe",
                    "Sugarcane__rust",
                    "Tea__algal_leaf", "Tea__anthracnose", "Tea__bird_eye_spot", "Tea__brown_blight", "Tea__healthy",
                    "Tea__red_leaf_spot",
